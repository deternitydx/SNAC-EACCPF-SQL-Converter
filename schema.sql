...
language_used       enum_language_code, -- from languageUsed/language (what the entity used)
script_used         enum_script_code,   -- from languageUsed,script (what the entity used)
biog_hist           text,
